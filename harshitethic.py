...
if aienv == None:
    openai.api_key = "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"
else:
...
if tgenv == None:
    tgkey = "6110043034:AAEi_w1qbyaXEbNVJIaGpkyTsk8h_58Bz6I"
else:
    tgkey = tgenv
print(tgenv)
...
qcache = None
chat_log = None
botname = '𒆜 ᴋᴜᴛᴛʏᴘᴏɴɴᴜ 𒆜'
username = 'MASK_movies_bot'
